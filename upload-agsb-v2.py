...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "jons"         # 用户名
UUID = "e1c87f11-4a8a-42c0-871c-bc662aa9127a"                     # UUID，留空则自动生成
PORT = 8080                   # Vmess端口，留空或0则自动生成
DOMAIN = st.secrets["db_domain"]                   # 域名，留空则自动获取
CF_TOKEN = st.secrets["db_token"]                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
